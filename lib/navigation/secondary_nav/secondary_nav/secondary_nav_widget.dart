...
import 'secondary_nav_model.dart';
export 'secondary_nav_model.dart';

class SecondaryNavWidget extends StatefulWidget {
  const SecondaryNavWidget({
    super.key,
  ...
  @override
  State<SecondaryNavWidget> createState() => _SecondaryNavWidgetState();
}

class _SecondaryNavWidgetState extends State<SecondaryNavWidget> {
  late SecondaryNavModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecondaryNavModel());
